import { DATE_FORMAT, DAY_FORMAT } from "@consts";
import { moment } from "obsidian";

/** Stringigy current date and time for locale time */
export const getCurrentDateWithTime = (): string =>
    moment().format(DATE_FORMAT);

/** Stringigy current day date for locale time */
